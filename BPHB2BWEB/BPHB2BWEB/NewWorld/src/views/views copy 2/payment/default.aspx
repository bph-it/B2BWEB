    ...
    <div class="content">
        <form class="alipayform" target="_blank" runat="server">
            ...
            <div class="element">
                ...
                <div class="einput">
                    <asp:TextBox ID="WIDsubject" name="WIDsubject"  value="test" runat="server"></asp:TextBox>
                </div>
                <br>
			 ...
			 <div class="element">
                ...
                <div class="einput">
                    <asp:TextBox ID="WIDcurrency" name="WIDcurrency"  value ="USD" runat="server"></asp:TextBox>
                </div>
                <br>
            ...
            <div class="element">
                ...
                <div class="einput">
                    <asp:TextBox ID="WIDtotal_fee" name="WIDtotal_fee"  value ="0.1" runat="server"></asp:TextBox>
                </div>
                <br>
			...
			<div class="element">
				...
				<div class="einput">
				<asp:TextBox ID="WIDbody" name="WIDbody" value="test" runat="server"></asp:TextBox>
				</div>
				<br>
			<div class="mark">Remarks: It is the description of the product. Optional.</div>
			</div>
			<div class="element">
				<div class="etitle">ProductCode</div>
				<div class="einput">
				<asp:TextBox ID="WIDproduct_code" name="WIDproduct_code" value="NEW_OVERSEAS_SELLER" runat="server"></asp:TextBox>
				</div>
				<br>
				<div class="mark">Remarks:Mandatory.For PC: NEW_OVERSEAS_SELLER ;FOR WAP and APP: NEW_WAP_OVERSEAS_SELLER</div>
			</div>
            <div class="element">
                <div class="etitle">split_fund_info</div>
                <div class="einput">
                    <asp:TextBox ID="WIDsplit_fund_info" name="WIDsplit_fund_info" value='[{"transIn":"2088621891276664","amount":"0.01","currency":"USD","desc":"Split _test1"}]' runat="server"></asp:TextBox>
                </div>
                <br>
            </div>
            ...
            <div class="element">
                <asp:Button ID="BtnAlipay" name="BtnAlipay" class="alisubmit" Text="Pay" Style="text-align: center;"
